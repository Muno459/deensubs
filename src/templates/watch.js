    ...
    <div class="wi">
      <div class="wi-top">
        ...
        <div class="wi-acts">
          ...
          <button class="wa wa-quiz" id="qz-btn" title="Quiz yourself" aria-label="Quiz yourself on this lecture"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg><span>Quiz yourself</span></button>
...
<div class="qz-modal" id="qz-modal" role="dialog" aria-modal="true" aria-label="Quiz yourself"><div class="qz-inner"><button class="qz-close" id="qz-close" aria-label="Close quiz">&times;</button><div id="qz-body"></div></div></div>
