...
${scholars.length?`<div class="search-scholars"><h2>Scholars</h2><div class="search-sch-row">${scholars.map(s=>`<a href="/scholar/${e(s.slug)}" class="search-sch-card card-anim">
