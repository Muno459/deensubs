        ...
        <GlowCard className="relative overflow-hidden p-6">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-1 max-w-xl text-[12px] leading-relaxed text-muted">
                Cloudflare downloads the video directly at the edge. The audio then goes to ElevenLabs
                Scribe v2 and Gemini at the same time: Scribe v2 transcribes every word with timestamps and
                speaker diarization, while Gemini listens to the same recording as it translates each window,
                keyed to those word timings — then writes chapters and metadata from the full transcript.
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <input
              ...
              placeholder="https://youtube.com, x.com, tiktok.com, facebook.com   or a direct .mp4 / .mp3 URL"
              value={url}
